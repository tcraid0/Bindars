...
function FocusBarComponent({
  ...
  // A paused autosave has no other signal in Focus mode, so its warning
  // keeps the bar on screen without waiting for the pointer.
  const visible = nearTop || saveWarning !== null;
