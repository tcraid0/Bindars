  ...
  return (
    <div
      ...
      style={{
        ...
        // bottom past the viewport, clipping controls at small heights. `dvh` is
        // the WebKit-accurate viewport height. Bounded so every control stays
        // reachable at the 400px minimum window height.
